...
<body>
    ...
    <div class="header">
        ...
        <tr>
            ...
            <td><a href="login-user.php"><button>Login</button></a></td>
        </tr>
       </table>
    ...
    <div id="home">
        <table border="0px">
            ...
            <tr>
                <td><a href="login-user.php"><button>Get Started!!</button></a></td>
            </tr>
        </table>
    </div>
    </div>
    ...
    <!--Learn-->
        ...
        <table border="0px" id="lt">
            ...
            <tr>
                ...
                <p>Upload all the pics, videos and audio you want to the editor. You can choose them from your device. If you want to make a video from scratch, just proceed to the next step.</p></td>
                <td>
                    <img src="step1.avif" >
            ...
            <tr>
                ...
                <p>Click on the tool image you want to use, go to tool page and click on "let's go" to proceed the changes.After editing go to next step.</p></td>
                <td>
                    <img src="step2.avif">
            ...
            <tr>
                <td><h2>STEP 3. <em>Save the result</em></h2>
                    ...
                    <p>After performing suitable changes the video will automatically downloaded in your device.</p></td>
                    <td>
                        <img src="step3.avif">
    ...
    <table border="0px" id="tooltable">
        ...
        <tr>
            <td>
                <table border="0px">
                    <tr><td><a href="header.php"><img src="screen-video-editor.png"></a></td></tr>
            ...
            <td>
                <table>
                    ...
                    <tr><td><p>Enter the necessary period of time to quickly cut your video file.</p></td></tr>
                </table>
            </td>
        </tr>
        <tr>
            ...
            <td >
                <table style="padding-left:65%;padding-top:10%;">
                    ...
                    <tr><td><p>Choose one of the prepared image as your video thumbnail.</p></td></tr>
                </table>
            </td>
        </tr>
    </table>
